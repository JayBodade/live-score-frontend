...
const UserView = () => {
  ...
  const [overData, setOverData] = useState({ 0: '', 1: '', 2: '', 3: '', 4: '', 5: '' });
    ...
    <div className="user-container h-fit sm:w-[100%] md:w-[60%] 405:w-[100%] w-[100%] 300:w-[105%] mx-auto border border-black">
      ...
      <div className="flex justify-between sm:w-[90%] md:w-[90%] 405:w-[80%] 560:w-[95%] 450:w-[70%]  524:w-[65%] lg:w-[83%] w-[83%] 300:w-[90%] mx-auto flex-wrap border p-4 border-black mb-4">
        ...
        let textColor = value == '' ? 'black' : colors[value].text;
          ...
          return <div
          key={key}
          className={`flex items-center text-${textColor} ${currentBall == key ? 'border-yellow-400 border-[8px]' : ""} justify-center w-14 h-14 border border-black rounded-full sm:mb-0 mb-2 sm:mx-0 mx-2 transition-transform transform hover:scale-110 shadow-lg`}
